...
var vGridCapital = [Double](repeating: 0.0, count: nGridCapital)
...
func Double2(cols: Int, rows: Int) -> [[Double]] {
	return [[Double]](repeating:[Double](repeating:Double(0.0), count: rows), count: cols)
}

var mOutput = Double2(cols: nGridCapital, rows: nGridProductivity)
var mValueFunction = Double2(cols: nGridCapital, rows: nGridProductivity)
var mValueFunctionNew = Double2(cols: nGridCapital, rows: nGridProductivity)
var mPolicyFunction = Double2(cols: nGridCapital, rows: nGridProductivity)
var expectedValueFunction = Double2(cols: nGridCapital, rows: nGridProductivity)
...
print("Iteration = \(iteration), Sup Diff = \(maxDifference)")
print()
print("My check = \(mPolicyFunction[999][2])")
print()

let cpu1  = get_cpu_time()

print("Elapsed time is   = \(cpu1  - cpu0)")
print()
